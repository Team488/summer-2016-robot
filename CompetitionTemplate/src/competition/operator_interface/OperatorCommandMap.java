...
import competition.subsystems.collector.commands.CollectCollectorCommand;
...
public class OperatorCommandMap {
    ...
    @Inject
    public void setupCollectorCommands(OperatorInterface oi, CollectCollectorCommand ccc, EjectCollectorCommand ecc){
